...
export default function Hero() {
  return (
    <section className="relative h-screen flex flex-col justify-end overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-32 md:pb-4">
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-start items-left space-y-4 sm:space-y-0 sm:space-x-6">
            <Link
              href="/projects"
              className="w-70 px-10 py-4 bg-primary text-white rounded-full font-black text-base hover:bg-primary-dark transition-all shadow-[0_10px_30px_rgba(16,185,129,0.25)] transform hover:scale-105 active:scale-95"
            >
              Explore Projects
            </Link>
          </div>
